...
function hello_portfolio_enqueue_scripts()
{
    // Ajouter le fichier JS
    wp_enqueue_script(
        "hello_portfolio-script", // Handle unique
...
add_action("wp_enqueue_scripts", "hello_portfolio_enqueue_scripts");

// Fonction pour inclure les styles CSS
function hello_portfolio_enqueue_styles()
{
    // Charger le style principal
    wp_enqueue_style(
        "hello_portfolio-style", // Handle unique
...
add_action("wp_enqueue_scripts", "hello_portfolio_enqueue_styles");
